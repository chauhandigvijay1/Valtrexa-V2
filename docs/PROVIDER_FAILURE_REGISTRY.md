...
### n8n Down
- **Detection**: HTTP connection refused on n8n webhook URL
- **Mitigation**: Events stored in DB, replayed when n8n recovers
- **Recovery**: Restart n8n, events will be delivered
